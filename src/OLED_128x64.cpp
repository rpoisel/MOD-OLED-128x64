...
void print_smtext(unsigned char row, const unsigned char *dataPtr, bool scr) {   //print small font text, input is row on LCD, text to print, should the text be scrollable(0/1)
...
void drawRectangle (int x1, int y1, int x2, int y2) {  //draw a rectangle
